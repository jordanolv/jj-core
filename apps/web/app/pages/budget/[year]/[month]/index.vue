...
const { getMonthDetails, createExpense } = useBudget();
...
<template>
  <div class="px-4 pb-4 sm:px-6 sm:pb-6">
    <div class="mx-auto max-w-6xl">
      ...
      <div v-else>
        <div class="mb-6 backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6">
          <p class="text-xs sm:text-sm font-medium text-slate-400">Dépenses totales</p>
